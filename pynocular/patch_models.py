...
def patch_database_model(
    ...
    async def create_list(models) -> List[DatabaseModel]:
        ...
        Returns:
            list of new DatabaseModels that have been saved
...
def _evaluate_true(column_element: True_, model: Dict[str, Any]) -> Any:
    # The boolean value True is its own SQLAlchemy element
    return True


@_evaluate_column_element.register(False_)
def _evaluate_false(column_element: False_, model: Dict[str, Any]) -> Any:
    # The boolean value False is its own SQLAlchemy element
    return False


@_evaluate_column_element.register(Grouping)
def _evaluate_grouping(column_element: Grouping, model: Dict[str, Any]) -> Any:
    return [
